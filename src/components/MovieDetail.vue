<template>
  <div class="mb-[300px]">
    <div class="top-details z-0">
      <div class="columns">
        <div class="column relative is-full featured_wrapper p-0">
          ...
          <div class="title_wrapper absolute top-[100px] right-[20%]" v-if="movieDetails">
    ...
    <div class="container px-[80px] mx-auto pb-[50px] z-40">
      <div class="poster-movies absolute bottom-[-150px]">
        <img :src="'https://image.tmdb.org/t/p/w185_and_h278_bestv2/' + movieDetails.poster_path" class="h-[450px] rounded-lg ">
      </div> 

      <div class="px-[50px] mt-5 mb-[100px] mx-auto absolute left-[30%] w-[50%]">
